...
//
        // Assuming you have customer info in ticketBooking
        JSONObject customer = new JSONObject();
        customer.put("name", payment.getTicketBooking().getUser().getName());
        customer.put("contact", payment.getTicketBooking().getUser().getPhone());
        customer.put("email", payment.getTicketBooking().getUser().getEmail());
        ...
        // Set notification and reminder settings
        JSONObject notify = new JSONObject();
        notify.put("sms", true);
        notify.put("email", true);
        paymentLinkRequest.put("notify", notify);
       ...
       //  Set callback URL
        paymentLinkRequest.put("callback_url", "http://localhost:4200/payment-success?order_id=" + payment.getPaymentId());
        paymentLinkRequest.put("callback_method", "get");
//
